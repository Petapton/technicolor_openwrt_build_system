...
{
#if defined(ZYXEL_CAT3_CABLE_LINK_UP_ON_VMG3926)   //enable ethernet@wirespeed of GE port, only set bit 4, don't touch other bits
    uint16 v16 = 0x8217;
    // 53125 p0~p3
    ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(1, 0), 0x18, &v16);
	ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(1, 1), 0x18, &v16);
	ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(1, 2), 0x18, &v16);
	ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(1, 3), 0x18, &v16);

    // internal GPHY
	v16 = 0x8077;
	ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(0, 3), 0x18, &v16);
#endif
