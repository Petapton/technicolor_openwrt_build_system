...
#define XTMRT_CMD_GLOBAL_REINITIALIZATION   20
#define XTMRT_CMD_SET_ATMBOND_SID_MODE      21
#define XTMRT_CMD_STOP_ALL_TX_QUEUE         22
#define XTMRT_CMD_START_ALL_TX_QUEUE        23
#else
