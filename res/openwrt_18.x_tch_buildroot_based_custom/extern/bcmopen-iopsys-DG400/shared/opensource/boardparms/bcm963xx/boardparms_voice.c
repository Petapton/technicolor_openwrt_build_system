...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_SI32260_QC =
{
   VOICECFG_SI32260_QC_STR,   /*Daughter card ID */
   {
      {
         /* Device Type */
         BP_VD_SILABS_32261,
         ...
         /* Channel description */
         {
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_SLIC, BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(4, 4) ),
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_SLIC, BP_VC_COMP_LINEAR, BP_VC_8KHZ, TS(5, 5) ),
         }
      },
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_SI32176x2 =
{
...
/* One Si32260_LCQC voice channels only. No Dect. */
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_SI32260_LCQC_single_slic_only =
{
   VOICECFG_SI32260_LCQC_STR,   /*Daughter card ID */
   {
      {
...
/* Two Si32260_LCQC voice channels only. No Dect. */
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_SI32260_LCQC_dual_slic_only =
{
   VOICECFG_SI32260_LCQC_STR,   /*Daughter card ID */
   {
      {
...
/* For older Inteno DG200 we fake an Si32260_LCQC even if VoiceBoardId
 * tell us it's SI32260_QC due to it's incorrectly written by factory. */
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_DG200_fake_SI32260_LCQC =
{
   VOICECFG_SI32260_QC_STR,   /*Daughter card ID */
   {
      {
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_ZL88801 =
{
...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_DECT_ONLY =
{
...
static VOICE_DAUGHTER_BOARD_PARMS * g_DG_dCardList_full[] = {
    &g_voiceBoard_NOSLIC,
...
static VOICE_DAUGHTER_BOARD_PARMS * g_DG_dCardList_dect_only[] = {
    &g_voiceBoard_DECT_ONLY,
    0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_DG_dCardList_noslic[] = {
    &g_voiceBoard_NOSLIC,
    0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_Iopsys_single_slic_only[] = {
    &g_voiceBoard_NOSLIC,
    &g_voiceBoard_SI32260_LCQC_single_slic_only,
    0
};

static VOICE_DAUGHTER_BOARD_PARMS * g_DG200_dCardList[] = {
    &g_voiceBoard_NOSLIC,
    &g_voiceBoard_SI32260_LCQC_dual_slic_only,
    &g_voiceBoard_DG200_fake_SI32260_LCQC,
    0
};
...
static bp_elem_t g_voice_bcmDG301R0[] = {
   ...
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_8_AH},
   {bp_iDectCfg,                .u.ptr = g_iDectStdCfg},
   {bp_daughterCardList,        .u.ptr = g_DG_dCardList_full},
   {bp_last}
};

static bp_elem_t g_voice_bcmVOX25[] = {
...
static bp_elem_t g_voice_bcmCG300R0[] = {                 
   {bp_cpBoardId,               .u.cp = "CG300R0"},           
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},             
   {bp_usFxsFxo2SpiSSNum,       .u.us = SPI_DEV_4},             
   {bp_usFxsFxo3SpiSSNum,       .u.us = SPI_DEV_5},             
   {bp_usGpioFxsFxoRst1,        .u.us = BP_NOT_DEFINED},          
   {bp_usGpioFxsFxoRst2,        .u.us = BP_NOT_DEFINED},          
   {bp_usGpioDectRst,           .u.us = BP_GPIO_18_AL},          
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_NOT_DEFINED},          
   {bp_iDectCfg,                .u.ptr = g_iDectStdCfg},        
   {bp_daughterCardList,        .u.ptr = g_DG_dCardList_dect_only},
   {bp_last}                                                    
};

static bp_elem_t g_voice_bcmCG301R0[] = {                 
...
static bp_elem_t g_voice_bcmDG301ALR0[] = {
   ...
   {bp_usGpioDectRst,           .u.us = BP_GPIO_18_AL},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_8_AH},
   {bp_daughterCardList,        .u.ptr = g_DG_dCardList_noslic},
   {bp_last}
};

static bp_elem_t g_voice_bcmEG200R0[] = {                 
	...
	{bp_usGpioDectRst,			.u.us = BP_GPIO_35_AL},
	{bp_usGpioVoipRelayCtrl1,	.u.us = BP_GPIO_12_AH},
	{bp_daughterCardList,		.u.ptr = g_Iopsys_single_slic_only},
	{bp_last}                                                    
};

static bp_elem_t g_voice_bcmEG300R0[] = {                 
...
static bp_elem_t g_voice_bcmDG200R0[]= {            
   ...
   {bp_usGpioDectRst,           .u.us = BP_GPIO_35_AL},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_12_AH},
   {bp_daughterCardList,        .u.ptr = g_DG200_dCardList},
   {bp_last}
};   

static bp_elem_t g_voice_bcmDG200ALR0[]= {
...
static VOICE_DAUGHTER_BOARD_PARMS * g_963138_dCardListInteno[] = {
   &g_voiceBoard_NOSLIC,
   &g_voiceBoard_SI32260_LCQC,
   &g_voiceBoard_SI32260_QC,
   &g_voiceBoard_ZL88801,
   0
};
...
static bp_elem_t g_voice_DG400R0[] = {
   ...
   {bp_usGpioFxsFxoRst3,        .u.us = BP_NOT_DEFINED},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_NOT_DEFINED},
   {bp_daughterCardList,        .u.ptr = g_963138_dCardListInteno},
   {bp_last}
};
...
static bp_elem_t g_voice_SDX810_RGR0[] = {
...
static bp_elem_t g_voice_bcmdg150v2r0[] = {
   {bp_cpBoardId,               .u.cp = "DG150V2R0"},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_NONE},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_bcm963381ref1},
   {bp_last}
};

static bp_elem_t g_voice_bcmdg150alv2r0[] = {
...
static bp_elem_t * g_VoiceBoardParms[]=
{
   g_voice_bcmdg150v2r0,
   g_voice_bcmdg150alv2r0,
...
int BpGetVoiceParms( char* pszVoiceDaughterCardId, VOICE_BOARD_PARMS* voiceParmsOut, char* pszBaseBoardId )
{
   ...
   for(pass = 0; pass < 2; pass++)
   {
    ...
    // Count of Iopsys Dect channels (including external).
    if(BpDectPopulated() == BP_DECT_POPULATED && vp.numDectLines == 0) {
        for(i = 0; i < BP_MAX_VOICE_DEVICES; i++) {
            for(j = 0; j < BP_MAX_CHANNELS_PER_DEVICE; j++) {
                if(pDc->voiceDevice[i].audioType == BP_VDTYPE_PCM &&
                        pDc->voiceDevice[i].channel[j].type == BP_VCTYPE_DECT) {
                    vp.numDectLines++;
                }
            }
        }
...
int BpGetVoiceDectType( const char *pszBaseBoardId )
{
   ...
   VOICE_DAUGHTER_BOARD_PARMS **daughterCardList;
   int i, j;
   ...
   if( dectChanCfg )
   {
      ...
      if(OTP_GET_USER_BIT(OTP_DECT_DISABLE)) return BP_VOICE_NO_DECT;
#endif
      return BP_VOICE_INT_DECT;
   }

   // Inteno externa Dect? Search for the voice daughter pointer.
   if(!BpGetNumVoiceBoardIds(pszBaseBoardId)) goto no_ext_dect;
   for(i = 0; pBpStartElem[i].id != bp_daughterCardList &&
      pBpStartElem[i].id != bp_last; i++);
   if(pBpStartElem[i].id == bp_last) goto no_ext_dect;
   daughterCardList = pBpStartElem[i].u.ptr;

   /* We need to iterate all daughter cards and check for possible external
    * Dect due to we can't be sure of which daughter is in use. This check
    * is done BEFORE(!) the user has the chance to enter the daughter option. */
   for(i = 0; daughterCardList[i]; i++)
   {
      for(j = 0; daughterCardList[i]->voiceDevice[j].deviceType != BP_VD_NONE; j++)
      {
         if(daughterCardList[i]->voiceDevice[j].deviceType == BP_VD_EDECT1)
            return BP_VOICE_EXT_DECT;
      }         
   }
no_ext_dect:
