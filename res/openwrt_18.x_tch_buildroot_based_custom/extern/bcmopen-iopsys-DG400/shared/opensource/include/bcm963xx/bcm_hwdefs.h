...
#define NVRAM_AUTH_KEY_LEN 16
#define NVRAM_DES_KEY_LEN 32
#define NVRAM_WPA_KEY_LEN 32
#define NVRAM_SERIAL_NUMBER_LEN 32
#define NVRAM_PSN_LEN 16
#define NVRAM_PCBASN_LEN 12
#define NVRAM_HWVER_LEN     4

#define RFPI_LEN 5
#define BCM_MOD_DEV_LEN 1
#define BCM_DEF_FREQ_LEN 2
#define FIXED_EMC_LEN 2

#define DEFAULT_RFPI ""
#define DEFAULT_BCM_MOD_DEV ""
#define DEFAULT_BCM_DEF_FREQ ""
#define DEFAULT_FIXED_EMC ""
...
# define NVFEAT_RESERVED    (1<<31)     // bit reserved for erasure detection
    ...
    char chUnused[110]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
    char production;                   // indicate telnet enable
    char hwVer[NVRAM_HWVER_LEN];
    char pcbasn[NVRAM_PCBASN_LEN];
    char psn[NVRAM_PSN_LEN];
    char iAntenna;
    char iVersion;
    char dslAnnex;
    char rfpi[RFPI_LEN];
    char bcm_mod_dev[BCM_MOD_DEV_LEN];
    char bcm_def_freq[BCM_DEF_FREQ_LEN];
    char fixed_emc[FIXED_EMC_LEN];
    char szAuthKey[NVRAM_AUTH_KEY_LEN];
    char szDesKey[NVRAM_DES_KEY_LEN];
    char szWpaKey[NVRAM_WPA_KEY_LEN];
