...
#define DOWNSTREAM_SERVICE_QUEUES_RATE_LIMITER_BUDGET_ALLOCATE_CODE_ID   DOWNSTREAM_RATE_LIMITER_BUDGET_ALLOCATE_CODE_ID
...
#else /* WL4908 */
#define UCAST_DROP_COMMAND_LIST_TIMESTAMP_START_OFFSET     44 /* RDD_FC_NATC_UCAST_FLOW_CONTEXT_ENTRY_COMMAND_LIST_NUMBER
                                                                 (start of the continuation command list in DDR) */
#endif
...
#define IPPROTO_IDX_ESP        5 /* 50 Encapsulation Security Payload     */
