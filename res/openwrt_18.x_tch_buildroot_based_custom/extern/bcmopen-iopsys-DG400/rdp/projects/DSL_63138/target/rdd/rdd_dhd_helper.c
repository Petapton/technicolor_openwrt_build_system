...
static void rdd_dhd_helper_tx_post_cpu_buffers_threshold_set(void)
{
...
#if defined(DSL_63138) || defined(DSL_63148) || defined(WL4908)
    g_cpu_tx_dhd_free_counter = g_cpu_tx_dhd_threshold = (g_cpu_tx_abs_packet_limit >> 2) * 3;
#else
    g_cpu_tx_dhd_free_counter = g_cpu_tx_dhd_threshold = (LILAC_RDD_CPU_TX_SKB_LIMIT_DEFAULT >> 2) * 3;
#endif
}
...
void rdd_dhd_mode_enable_init(void)
{
    ...
    rdd_dhd_helper_tx_post_cpu_buffers_threshold_set();
}
