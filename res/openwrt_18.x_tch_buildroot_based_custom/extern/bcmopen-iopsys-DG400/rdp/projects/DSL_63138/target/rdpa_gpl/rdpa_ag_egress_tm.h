...
typedef enum {
    ...
    rdpa_egress_tm_attr_index = 1, /* index : KRI : number : Egress-TM Index */
    rdpa_egress_tm_attr_level = 2, /* level : RI : enum : Egress-TM Next Level */
    rdpa_egress_tm_attr_mode = 3, /* mode : RI : enum : Scheduler Operating Mode */
    rdpa_egress_tm_attr_overall_rl = 4, /* overall_rl : RI : bool : Overall Rate Limiter */
    rdpa_egress_tm_attr_service_queue = 5, /* service_queue : RI : aggregate service_queue_cfg(rdpa_tm_service_queue_t) : Service Queue Parameters Configuration */
    rdpa_egress_tm_attr_enable = 6, /* enable : RW : bool : Enable object */
    ...
    rdpa_egress_tm_attr_queue_flush = 12, /* queue_flush : W : bool[(tm_queue_index)] : Flush Egress Queue */
    rdpa_egress_tm_attr_queue_statistics = 13, /* queue_statistics : RF : aggregate[(tm_queue_index)] rdpa_stat_1way(rdpa_stat_1way_t) : Dropped Service Queue Statistics */
    rdpa_egress_tm_attr_queue_stat = 14, /* queue_stat : RWF : aggregate[(tm_queue_index)] rdpa_stat_1way(rdpa_stat_1way_t) : Retrieve Egress Queue Statistics */
    rdpa_egress_tm_attr_queue_occupancy = 15, /* queue_occupancy : RF : number[(tm_queue_index)] : Retrieve Egress Queue Occupancy */
    rdpa_egress_tm_attr_subsidiary = 16, /* subsidiary : RWF : object[] : Next Level Egress-TM */
    rdpa_egress_tm_attr_weight = 17, /* weight : RW : number : Weight for WRR scheduling (0 for unset) */
