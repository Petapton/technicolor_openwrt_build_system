...
#if defined(BCM63158)
#define RDPA_CMD_LIST_PACKET_HEADER_MAX_LENGTH   106
#define RDPA_CMD_LIST_PACKET_BUFFER_OFFSET       152
#define RDPA_CMD_LIST_PACKET_HEADER_OFFSET       62
#define RDPA_CMD_LIST_UCAST_LIST_OFFSET          12
...
#define RDPA_CMD_LIST_UCAST_LIST_OFFSET          16
#define RDPA_CMD_LIST_HEADROOM                   58
#endif

#define RDPA_CMD_LIST_UCAST_LIST_SIZE            112
