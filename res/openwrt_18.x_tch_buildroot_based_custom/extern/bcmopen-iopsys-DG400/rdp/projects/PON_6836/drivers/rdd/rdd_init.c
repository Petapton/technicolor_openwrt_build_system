...
static void image_0_context_set(uint32_t core_index)
{
    ...
    local_regs[IMAGE_0_DS_TM_WAN_DIRECT_THREAD_NUMBER][reg_id[11]] = QM_QUEUE_CPU_RX_COPY_EXCLUSIVE | ( IMAGE_0_DIRECT_PROCESSING_EPON_CONTROL_SCRATCH_ADDRESS << 16 );
#ifndef _CFE_
    ...
    local_regs[IMAGE_0_DS_TM_TX_TASK_THREAD_NUMBER][reg_id[12]] = (IMAGE_0_BBH_TX_EGRESS_COUNTER_TABLE_ADDRESS << 16);
    local_regs[IMAGE_0_DS_TM_TX_TASK_THREAD_NUMBER][reg_id[11]] = BB_ID_TX_LAN;
    local_regs[IMAGE_0_DS_TM_TX_TASK_THREAD_NUMBER][reg_id[10]] = IMAGE_0_PD_FIFO_TABLE_ADDRESS | (IMAGE_0_BASIC_RATE_LIMITER_TABLE_ADDRESS << 16);
    local_regs[IMAGE_0_DS_TM_TX_TASK_THREAD_NUMBER][reg_id[9]] = (IMAGE_0_SCHEDULING_QUEUE_TABLE_ADDRESS << 16); 
    local_regs[IMAGE_0_DS_TM_TX_TASK_THREAD_NUMBER][reg_id[8]]  = IMAGE_0_BBH_QUEUE_TABLE_ADDRESS | (IMAGE_0_BASIC_SCHEDULER_TABLE_ADDRESS << 16);
...
static void image_1_context_set(uint32_t core_index)
{
    ...
    /* CPU_RX_UPDATE_FIFO_READ: thread 9 */
    ...
    /* CPU_INTERRUPT_COALESCING: thread 10 */
...
static void image_2_context_set(uint32_t core_index)
{
    ...
    /* CPU_TX_UPDATE_FIFO_EGRESS: thread 8 */
    ...
    /* CPU_TX_UPDATE_FIFO_INGRESS: thread 9 */
    ...
    /* CPU_INTERRUPT_COALESCING: thread 13 */
...
{
    LAYER2_HEADER_COPY_ROUTINE_ARRAY(processing0_layer2_header_copy_routine_arr, image_4, processing_layer2_header_copy);
...
static void rdd_actions_proj_init(void)
{
    ...
    uint16_t processing0_rule_based_context_actions_arr[] = {
    ...
    uint16_t processing1_flow_actions_arr[] = {
        ...
        [1] = ADDRESS_OF(image_1, action_default),
    ...
    uint16_t processing1_rule_actions_arr[] = {
        [0] = ADDRESS_OF(image_1, action_dei_rule_based),
        [1] = ADDRESS_OF(image_1, action_no_fwd),
        [2] = ADDRESS_OF(image_1, action_dscp_remarking_rule_based),
    ...
    uint16_t processing1_rule_based_context_actions_arr[] = {
        [0] = ADDRESS_OF(image_1, action_no_fwd),
        [1] = ADDRESS_OF(image_1, mcast_resolution_common_actions_done),
        [2 ... 16] = ADDRESS_OF(image_1, action_default)
    };

    uint16_t processing1_iptv_actions_arr[] = {
        [0] = ADDRESS_OF(image_1, action_tc_to_queue_iptv),
        [1] = ADDRESS_OF(image_1, action_vlan_iptv),
        [2] = ADDRESS_OF(image_1, mcast_repl_0_header_update),                
        [3] = ADDRESS_OF(image_1, cpu_mcast_execution_engine_done),
        [4 ... 15] = ADDRESS_OF(image_1, action_exception),
        [16] = ADDRESS_OF(image_1, mcast_repl_res_loop_header_update)
    };
    ...
    uint16_t processing2_flow_actions_arr[] = {
        ...
        [1] = ADDRESS_OF(image_2, action_default),
    ...
    uint16_t processing2_rule_actions_arr[] = {
        [0] = ADDRESS_OF(image_2, action_dei_rule_based),
        [1] = ADDRESS_OF(image_2, action_no_fwd),
        [2] = ADDRESS_OF(image_2, action_dscp_remarking_rule_based),
    ...
    uint16_t processing2_rule_based_context_actions_arr[] = {
        [0] = ADDRESS_OF(image_2, action_no_fwd),
        [1] = ADDRESS_OF(image_2, mcast_resolution_common_actions_done),
        [2 ... 16] = ADDRESS_OF(image_2, action_default)
    };

    uint16_t processing2_iptv_actions_arr[] = {
        [0] = ADDRESS_OF(image_2, action_tc_to_queue_iptv),
        [1] = ADDRESS_OF(image_2, action_vlan_iptv),
        [2] = ADDRESS_OF(image_2, mcast_repl_0_header_update),                
        [3] = ADDRESS_OF(image_2, cpu_mcast_execution_engine_done),
        [4 ... 15] = ADDRESS_OF(image_2, action_exception),
        [3 ... 15] = ADDRESS_OF(image_2, action_exception),
        [16] = ADDRESS_OF(image_2, mcast_repl_res_loop_header_update)
    };
    ...
    for (core_index = 0; core_index < GROUPED_EN_SEGMENTS_NUM; core_index++)
    {
        ...
        if (rdp_core_to_image_map[core_index] == processing0_runner_image)
        {
            ...
            rdd_write_action(core_index, processing0_rule_based_context_actions_arr, sizeof(processing0_rule_based_context_actions_arr)/sizeof(processing0_rule_based_context_actions_arr[0]),
                (uint8_t *)RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_PTR(core_index), RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_SIZE, image_4_action_exception);
        ...
        else if (rdp_core_to_image_map[core_index] == processing1_runner_image)
        {
            ...
            rdd_write_action(core_index, processing1_rule_based_context_actions_arr, sizeof(processing1_rule_based_context_actions_arr)/sizeof(processing1_rule_based_context_actions_arr[0]),
                (uint8_t *)RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_PTR(core_index), RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_SIZE, image_1_action_exception);
        ...
        else if (rdp_core_to_image_map[core_index] == processing2_runner_image)
        {
            ...
            rdd_write_action(core_index, processing2_rule_based_context_actions_arr, sizeof(processing2_rule_based_context_actions_arr)/sizeof(processing2_rule_based_context_actions_arr[0]),
                (uint8_t *)RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_PTR(core_index), RDD_RULE_BASED_CONTEXT_ACTION_PTR_TABLE_SIZE, image_2_action_exception);
