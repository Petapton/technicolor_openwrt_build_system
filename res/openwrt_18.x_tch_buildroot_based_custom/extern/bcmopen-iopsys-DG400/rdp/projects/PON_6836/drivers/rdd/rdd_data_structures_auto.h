...
#define RDD_IC_EXT_CONTEXT_TABLE_SIZE     512
typedef struct
{
...
typedef enum
{
	...
	DISP_REOR_VIQ_EPON_TM           = 14,
	DISP_REOR_VIQ_CPU_TX_EGRESS     = 15,
	DISP_REOR_VIQ_CPU_TX_FORWARD    = 16,
	DISP_REOR_VIQ_US_TM_FLUSH       = 17,
	DISP_REOR_VIQ_DS_TM_FLUSH       = 18,
	DISP_REOR_VIQ_TX_MIRRORING      = 19,
	DISP_REOR_VIQ_CPU_RX_COPY       = 20,
	DISP_REOR_VIQ_LAST              = 20
} rdd_disp_reor_viq;
typedef enum
{
...
typedef enum
{
	...
	IMAGE_2_CPU_IF_2_TIMER_INDEX_INTERRUPT_COALESCING = 0,
	IMAGE_2_CPU_IF_2_TIMER_INDEX_LAST            = 0
...
typedef enum
{
	...
	IMAGE_3_US_TM_TIMER_INDEX_REPORTING       = 3,
...
typedef enum
{
	...
	QM_QUEUE_US_END                   = 71,
	QM_QUEUE_DS_START                 = 72,
	QM_QUEUE_DS_END                   = 127,
	QM_QUEUE_CPU_RX                   = 128,
	QM_QUEUE_CPU_TX_EGRESS            = 129,
	QM_QUEUE_CPU_TX_INGRESS           = 130,
	QM_QUEUE_DROP                     = 131,
	QM_QUEUE_CPU_RX_COPY_EXCLUSIVE    = 132,
	QM_QUEUE_CPU_RX_COPY_NORMAL       = 133,
	QM_QUEUE_LAST                     = 133
} rdd_qm_queue;
typedef enum
{
	IMAGE_0_DS_TM_FIRST                      = 0,
	IMAGE_0_DS_TM_WAN_DIRECT_THREAD_NUMBER   = 0,
	...
	IMAGE_0_DS_TM_LAST                       = 4
} rdd_ds_tm;
typedef enum
{
	IMAGE_1_IMAGE_1_FIRST                                  = 0,
	IMAGE_1_IMAGE_1_PROCESSING0_THREAD_NUMBER              = 0,
	IMAGE_1_IMAGE_1_PROCESSING1_THREAD_NUMBER              = 1,
	IMAGE_1_IMAGE_1_PROCESSING2_THREAD_NUMBER              = 2,
	IMAGE_1_IMAGE_1_PROCESSING3_THREAD_NUMBER              = 3,
	IMAGE_1_IMAGE_1_PROCESSING4_THREAD_NUMBER              = 4,
	IMAGE_1_IMAGE_1_PROCESSING5_THREAD_NUMBER              = 5,
	IMAGE_1_IMAGE_1_PROCESSING6_THREAD_NUMBER              = 6,
	IMAGE_1_IMAGE_1_PROCESSING7_THREAD_NUMBER              = 7,
	IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER                   = 8,
	IMAGE_1_IMAGE_1_CPU_RX_UPDATE_FIFO_THREAD_NUMBER       = 9,
	IMAGE_1_IMAGE_1_INTERRUPT_COALESCING_THREAD_NUMBER     = 10,
	IMAGE_1_IMAGE_1_CPU_RX_METER_BUDGET_ALLOCATOR_THREAD_NUMBER = 11,
	IMAGE_1_IMAGE_1_CPU_RECYCLE_THREAD_NUMBER              = 12,
	IMAGE_1_IMAGE_1_CPU_RX_COPY_THREAD_NUMBER              = 13,
	IMAGE_1_IMAGE_1_CPU_RX_COPY_UPDATE_FIFO_THREAD_NUMBER  = 14,
	IMAGE_1_IMAGE_1_LAST                                   = 14
} rdd_image_1;
typedef enum
{
	IMAGE_2_IMAGE_2_FIRST                               = 0,
	IMAGE_2_IMAGE_2_PROCESSING0_THREAD_NUMBER           = 0,
	IMAGE_2_IMAGE_2_PROCESSING1_THREAD_NUMBER           = 1,
	IMAGE_2_IMAGE_2_PROCESSING2_THREAD_NUMBER           = 2,
	IMAGE_2_IMAGE_2_PROCESSING3_THREAD_NUMBER           = 3,
	IMAGE_2_IMAGE_2_PROCESSING4_THREAD_NUMBER           = 4,
	IMAGE_2_IMAGE_2_PROCESSING5_THREAD_NUMBER           = 5,
	IMAGE_2_IMAGE_2_PROCESSING6_THREAD_NUMBER           = 6,
	IMAGE_2_IMAGE_2_PROCESSING7_THREAD_NUMBER           = 7,
	IMAGE_2_IMAGE_2_CPU_TX_UPDATE_FIFO_EGRESS_THREAD_NUMBER = 8,
	IMAGE_2_IMAGE_2_CPU_TX_UPDATE_FIFO_INGRESS_THREAD_NUMBER = 9,
	IMAGE_2_IMAGE_2_CPU_RECYCLE_THREAD_NUMBER           = 10,
	IMAGE_2_IMAGE_2_CPU_TX_EGRESS_THREAD_NUMBER         = 11,
	IMAGE_2_IMAGE_2_CPU_TX_INGRESS_THREAD_NUMBER        = 12,
	IMAGE_2_IMAGE_2_INTERRUPT_COALESCING_THREAD_NUMBER  = 13,
	IMAGE_2_IMAGE_2_LAST                                = 13
} rdd_image_2;
typedef enum
{
	...
	IMAGE_3_US_TM_REPORTING_THREAD_NUMBER        = 10,
