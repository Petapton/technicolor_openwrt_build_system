...
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_3_READ(r, p)                      MREAD_32((uint8_t *)p + 60, r)
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_3_WRITE(v, p)                     MWRITE_32((uint8_t *)p + 60, v)
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_4_READ(r, p)                      MREAD_32((uint8_t *)p + 64, r)
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_4_WRITE(v, p)                     MWRITE_32((uint8_t *)p + 64, v)
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_5_READ(r, p)                      MREAD_16((uint8_t *)p + 68, r)
#define RDD_SPDSVC_CONTEXT_ENTRY_ETH_HEADER_5_WRITE(v, p)                     MWRITE_16((uint8_t *)p + 68, v)
