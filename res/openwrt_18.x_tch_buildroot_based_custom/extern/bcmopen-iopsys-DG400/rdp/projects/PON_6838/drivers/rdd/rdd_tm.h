...
/* Name:                                                                      */
/*                                                                            */
/*   rdd_wan_ack_packets_queue_index_config                                   */
/*                                                                            */
/* Title:                                                                     */
/*                                                                            */
/*   Firmware Driver - configure upstream TCONT                               */
...
/* Abstract:                                                                  */
/*                                                                            */
/*   This function configures the queue index for ack packets                 */
/*     of a single TCONT.                                                     */
/*                                                                            */
/* Input:                                                                     */
/*                                                                            */
/*   xi_wan_channel_id - T-CONT index                                         */
/*   xi_rate_controller - rate controller index                               */
/*   xi_queue - queue index or ack packets                                    */
/*                                                                            */
/* Output:                                                                    */
/*                                                                            */
/*   BL_LILAC_RDD_ERROR_DTE - Return status                                   */
...
/*   xi_counter_id - statistics counter id (128-255), 0 - disable statistics  */
/*                                                                            */
/* Output:                                                                    */
/*                                                                            */
/*   BL_LILAC_RDD_ERROR_DTE - Return status                                   */
...
/* Name:                                                                      */
/*                                                                            */
/*   rdd_wan_tx_ddr_queue_addr_config                                         */
/*                                                                            */
/* Title:                                                                     */
/*                                                                            */
/*   Firmware Driver - configure upstream GPON TX queue DDR address           */
/*                                                                            */
/* Abstract:                                                                  */
/*                                                                            */
/*   configures GPON TX queue:                                                */
...
/*   xi_rate_controller_id - rate controller index                            */
/*   xi_queue_id - GPON TX queue index                                        */
/*   xi_ddr_address - queue address in DDR                                    */
/*   xi_counter_id - statistics counter id (128-255), 0 - disable statistics  */   
/*                                                                            */
/******************************************************************************/
...
/* Name:                                                                      */
/*                                                                            */
/*   rdd_inter_lan_scheduling_mode_config                                     */
/*                                                                            */
/* Title:                                                                     */
/*                                                                            */
/*   Firmware Driver - configure LAN ports scheduling and wiring mode.        */
/*                                                                            */
/* Abstract:                                                                  */
/*                                                                            */
/*    THis feature configures LAN ports scheduling and wiring mode:           */
/*    1. Normal mode - each LAN is connected to a different BBH port, with    */
/*       RR schedueling mechansim and multiple FW tasks for all ports.        */
/*    2. Strict Priority - each LAN is connected to a different BBH port,     */
/*       with strict priority schedueling mechansim and a single FW task      */
/*       for all ports.                                                       */
/*    3. Round robin - each LAN is connected to a single BBH port, set by     */
/*       xi_emac_id parameter, with round robin schedueling mechansim and     */
/*       a single FW task for all ports.                                      */
/*                                                                            */
/* Input:                                                                     */
/*                                                                            */
/*   xi_inter_lan_scheduling_mode - see above explanation                     */
/*   xi_emac_id - for extrnal switch EMAC0-EMAC4 or 0 when disbaled           */
/*                                                                            */
/* Output:                                                                    */
/*                                                                            */
/*   BL_LILAC_RDD_ERROR_DTE - Return status                                   */
...
/* Abstract:                                                                  */
/*                                                                            */
/*   This function configures loopback of packets on specific EMAC egress     */
/*   port, when enabled all the packets that are subject to transmit through  */
/*   the EMAC will be loopacked to the upstream flow.                         */
/*                                                                            */
/* Input:                                                                     */
/*                                                                            */
/*   xi_emac_id - EMAC port index (ETH0 - ETH4)                               */
/*   xi_loopback_mode - enable disable the loopback on the egress port        */
/*                                                                            */
/* Output:                                                                    */
/*                                                                            */
/*   BL_LILAC_RDD_ERROR_DTE - Return status                                   */
...
/* Name:                                                                      */
/*                                                                            */
/*   rdd_G9991_sid_to_physical_port_mapping_config                            */
/*                                                                            */
/* Title:                                                                     */
/*                                                                            */
/*   Firmware Driver - G9991 SID configuration.                               */
/*                                                                            */
/* Abstract:                                                                  */
/*                                                                            */
/*   This function configures physical port to SID                            */
/*                                                                            */
/* Input:                                                                     */
/*                                                                            */
/*   xi_sid - 0-20                                                            */
...
/*                                                                            */
/******************************************************************************/
BL_LILAC_RDD_ERROR_DTE rdd_G9991_virtual_to_physical_port_mapping_config ( BL_LILAC_RDD_EMAC_ID_DTE  xi_virtual,
                                                                           BL_LILAC_RDD_EMAC_ID_DTE  xi_emac_id );
#endif
...
/* Abstract:                                                                  */
/*                                                                            */
/*   This function configures common BPM threshold                            */
/*                                                                            */
/*                                                                            */
/* Input:                                                                     */
/*                                                                            */
/*   xi_common_bpm_threshold -                                                */
/*                                                                            */
/******************************************************************************/
