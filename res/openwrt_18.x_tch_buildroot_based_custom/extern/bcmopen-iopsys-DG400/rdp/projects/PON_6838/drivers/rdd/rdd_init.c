...
static BL_LILAC_RDD_ERROR_DTE f_rdd_local_registers_initialize ( BL_LILAC_RDD_BRIDGE_PORT_DTE        lan_direct_to_cpu_port )
{
    ...
    /* CPU-RX interrupt coalescing timer: thread 33 */
    ...
    local_register[ TIMER_SCHEDULER_PICO_THREAD_NUMBER - 32 ][ CS_R20 ] = DS_RATE_LIMITER_TABLE_ADDRESS;
    local_register[ TIMER_SCHEDULER_PICO_THREAD_NUMBER - 32 ][ CS_R21 ] = RATE_LIMITER_REMAINDER_TABLE_ADDRESS;

#ifndef G9991
    /* WLAN Multicast: thread 27 */
...
static void rdd_actions_proj_init(void)
{
    ...
    uint16_t ds_main_actions_arr[] = {
        ...
        [1]  = ADDRESS_OF(runner_a, action_default),
        [2]  = ADDRESS_OF(runner_a, action_ttl_decrement),
        [3]  = ADDRESS_OF(runner_a, action_policer),
    ...
    uint16_t us_main_actions_arr[] = {
        ...
        [1]  = ADDRESS_OF(runner_b, action_default),
        [2]  = ADDRESS_OF(runner_b, action_ttl_decrement),
        [3]  = ADDRESS_OF(runner_b, action_policer),
