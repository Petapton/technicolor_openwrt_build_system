...

{
    ...
    *xo_rule_cfg_lookup_mode = rule_cfg_lookup_mode;
    ...
    else
    {
        ...
        while ( 1 )
        {
            if ( ( next_rule_cfg_id == ingress_classification_rule_cfg_table_size ) || ( xi_rule_cfg_priority > g_ingress_classification_rule_cfg_table[ xi_direction ].rule_cfg[ next_rule_cfg_id ].priority ) )
            {
