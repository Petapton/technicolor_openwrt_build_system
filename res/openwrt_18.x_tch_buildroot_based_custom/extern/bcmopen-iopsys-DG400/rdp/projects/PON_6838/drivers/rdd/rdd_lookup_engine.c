                                                          ...
                                                          uint32_t              *xo_entry_index )
{
    ...
    {
        xi_crc_init_value =  rdd_crc_init_value_get( RDD_CRC_TYPE_16 );
    }

    xi_crc_init_value = rdd_crc_bit_by_bit ( &xi_hash_key[ 0 ], 1, 4, xi_crc_init_value, RDD_CRC_TYPE_16 );

    /* calculate the CRC on the key */
    hash_index = rdd_crc_bit_by_bit ( &xi_hash_key[ 2 ], 6, 0, xi_crc_init_value, RDD_CRC_TYPE_16 );
                                                    ...
                                                    uint32_t              *xo_entry_index )
{
    ...
    xi_crc_init_value = rdd_crc_bit_by_bit ( &hash_key[ 0 ], 1, 4, xi_crc_init_value, RDD_CRC_TYPE_16 );

    hash_index = rdd_crc_bit_by_bit ( &hash_key[ 2 ], 6, 0, xi_crc_init_value, RDD_CRC_TYPE_16 );
                                             ...
                                             uint8_t          *xi_hash_key )
{
    ...
    crc_value = rdd_crc_bit_by_bit ( &xi_hash_key[ 0 ], 16, 0, 0xffffffff, RDD_CRC_TYPE_32 );
