                                                           ...
                                                           uint16_t                    *xo_drop_counter )
{
    ...
    rdd_error = rdd_2_bytes_counter_get ( CPU_RX_METERS_DROPPED_PACKETS_GROUP, xi_direction * BL_LILAC_RDD_CPU_METER_DISABLE + xi_cpu_meter, LILAC_RDD_TRUE, xo_drop_counter );
