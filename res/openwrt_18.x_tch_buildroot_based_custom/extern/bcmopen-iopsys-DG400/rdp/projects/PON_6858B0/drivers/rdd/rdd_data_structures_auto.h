...
#define RDD_SCHEDULING_QUEUE_TABLE_SIZE     160
typedef struct
{
...
#define RDD_BBH_TX_EGRESS_COUNTER_TABLE_SIZE     8
typedef struct
{
...
#define RDD_BBH_TX_QUEUE_ID_TABLE_SIZE     2
typedef struct
{
	RDD_BBH_TX_QUEUE_ID_ENTRY_DTS	entry[ RDD_BBH_TX_QUEUE_ID_TABLE_SIZE ];
}
...
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_NUMBER	2
...
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_LOW_READ_G(r, g, idx)                          GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 24, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_LOW_WRITE_G(v, g, idx)                         GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 24, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_LOW_READ(r, p)                                 MREAD_32((uint8_t *)p + 24, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_LOW_WRITE(v, p)                                MWRITE_32((uint8_t *)p + 24, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_HIGH_READ_G(r, g, idx)                         GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 28, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_HIGH_WRITE_G(v, g, idx)                        GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 28, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_HIGH_READ(r, p)                                MREAD_32((uint8_t *)p + 28, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_HIGH_WRITE(v, p)                               MWRITE_32((uint8_t *)p + 28, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_WR_IDX_READ_G(r, g, idx)                            GROUP_MREAD_16(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 32, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_WR_IDX_WRITE_G(v, g, idx)                           GROUP_MWRITE_16(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 32, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_WR_IDX_READ(r, p)                                   MREAD_16((uint8_t *)p + 32, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_WR_IDX_WRITE(v, p)                                  MWRITE_16((uint8_t *)p + 32, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_RD_IDX_READ_G(r, g, idx)                            GROUP_MREAD_16(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 34, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_RD_IDX_WRITE_G(v, g, idx)                           GROUP_MWRITE_16(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 34, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_RD_IDX_READ(r, p)                                   MREAD_16((uint8_t *)p + 34, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_TX_POST_RD_IDX_WRITE(v, p)                                  MWRITE_16((uint8_t *)p + 34, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CAM_RSLT_READ_G(r, g, idx)                                  GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 36, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CAM_RSLT_WRITE_G(v, g, idx)                                 GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 36, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CAM_RSLT_READ(r, p)                                         MREAD_32((uint8_t *)p + 36, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CAM_RSLT_WRITE(v, p)                                        MWRITE_32((uint8_t *)p + 36, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_ADD_LLCSNAP_HEADER_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 7, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_ADD_LLCSNAP_HEADER_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 7, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_ADD_LLCSNAP_HEADER_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 40, 7, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_ADD_LLCSNAP_HEADER_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 40, 7, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_CPU_TX_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 6, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_CPU_TX_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 6, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_CPU_TX_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 40, 6, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_CPU_TX_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 40, 6, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_NON_UDP_TCP_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 5, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_NON_UDP_TCP_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 40, 5, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_NON_UDP_TCP_READ(r, p)                   FIELD_MREAD_8((uint8_t *)p + 40, 5, 1, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_NON_UDP_TCP_WRITE(v, p)                  FIELD_MWRITE_8((uint8_t *)p + 40, 5, 1, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_TCP_PKTLEN_READ_G(r, g, idx)             GROUP_MREAD_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 41, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_TCP_PKTLEN_WRITE_G(v, g, idx)            GROUP_MWRITE_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 41, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_TCP_PKTLEN_READ(r, p)                    MREAD_8((uint8_t *)p + 41, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_TCP_PKTLEN_WRITE(v, p)                   MWRITE_8((uint8_t *)p + 41, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CACHE_CTX_NEXT_WRITE_IDX_READ_G(r, g, idx)                  GROUP_MREAD_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 42, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CACHE_CTX_NEXT_WRITE_IDX_WRITE_G(v, g, idx)                 GROUP_MWRITE_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 42, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CACHE_CTX_NEXT_WRITE_IDX_READ(r, p)                         MREAD_8((uint8_t *)p + 42, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_CACHE_CTX_NEXT_WRITE_IDX_WRITE(v, p)                        MWRITE_8((uint8_t *)p + 42, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_READ_G(r, g, idx, i)          GROUP_MREAD_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 44, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_WRITE_G(v, g, idx, i)         GROUP_MWRITE_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 44, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_READ(r, p, i)                 MREAD_I_8((uint8_t *)p + 44, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_WRITE(v, p, i)                MWRITE_I_8((uint8_t *)p + 44, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_READ_G(r, g, idx, i)            GROUP_MREAD_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 48, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_WRITE_G(v, g, idx, i)           GROUP_MWRITE_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 48, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_READ(r, p, i)                   MREAD_I_8((uint8_t *)p + 48, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_WRITE(v, p, i)                  MWRITE_I_8((uint8_t *)p + 48, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 52, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 52, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_READ(r, p, i)              MREAD_I_8((uint8_t *)p + 52, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_WRITE(v, p, i)             MWRITE_I_8((uint8_t *)p + 52, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_READ_G(r, g, idx, i)                             GROUP_MREAD_I_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 56, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_WRITE_G(v, g, idx, i)                            GROUP_MWRITE_I_32(g, idx*sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS) + 56, i, v)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_READ(r, p, i)                                    MREAD_I_32((uint8_t *)p + 56, i, r)
#define RDD_DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_WRITE(v, p, i)                                   MWRITE_I_32((uint8_t *)p + 56, i, v)
...
#define RDD_DHD_DOORBELL_VALUE_SIZE     3
typedef struct
{
	RDD_DHD_DOORBELL_DTS	entry[ RDD_DHD_DOORBELL_VALUE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DHD_DOORBELL_VALUE_DTS;

extern uint32_t RDD_DHD_DOORBELL_VALUE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DHD_DOORBELL_VALUE_PTR(core_id)	( RDD_DHD_DOORBELL_VALUE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DHD_DOORBELL_VALUE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	uint32_t	size_and_flags     	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved           	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	flow_ring_base_low 	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	flow_ring_base_high	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_FLOW_RING_BASE_LOW_READ_G(r, g, idx)           GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS), r)
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_FLOW_RING_BASE_LOW_WRITE_G(v, g, idx)          GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS), v)
...
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_FLOW_RING_BASE_HIGH_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS) + 4, r)
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_FLOW_RING_BASE_HIGH_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS) + 4, v)
...
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_SIZE_AND_FLAGS_READ_G(r, g, idx)               GROUP_MREAD_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS) + 8, r)
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_SIZE_AND_FLAGS_WRITE_G(v, g, idx)              GROUP_MWRITE_32(g, idx*sizeof(RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS) + 8, v)
...
#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_SIZE     3
typedef struct
{
	RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_DTS	entry[ RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_DTS;

extern uint32_t RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_PTR(core_id)	( RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DHD_TX_POST_FLOW_RING_MGMT_DESCRIPTOR_BUFFER_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	uint32_t	reserved1         	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	fpm_low_threshold 	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	fpm_high_threshold	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	aggr_timer_period 	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	reserved1         	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	rx_post_fpm_pool  	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_DHD_HW_CONFIGURATION_FPM_LOW_THRESHOLD_READ_G(r, g, idx)           GROUP_MREAD_16(g, idx*sizeof(RDD_DHD_HW_CONFIGURATION_DTS) + 8, r)
#define RDD_DHD_HW_CONFIGURATION_FPM_LOW_THRESHOLD_WRITE_G(v, g, idx)          GROUP_MWRITE_16(g, idx*sizeof(RDD_DHD_HW_CONFIGURATION_DTS) + 8, v)
#define RDD_DHD_HW_CONFIGURATION_FPM_LOW_THRESHOLD_READ(r, p)                  MREAD_16((uint8_t *)p + 8, r)
#define RDD_DHD_HW_CONFIGURATION_FPM_LOW_THRESHOLD_WRITE(v, p)                 MWRITE_16((uint8_t *)p + 8, v)
#define RDD_DHD_HW_CONFIGURATION_FPM_HIGH_THRESHOLD_READ_G(r, g, idx)          GROUP_MREAD_16(g, idx*sizeof(RDD_DHD_HW_CONFIGURATION_DTS) + 10, r)
#define RDD_DHD_HW_CONFIGURATION_FPM_HIGH_THRESHOLD_WRITE_G(v, g, idx)         GROUP_MWRITE_16(g, idx*sizeof(RDD_DHD_HW_CONFIGURATION_DTS) + 10, v)
#define RDD_DHD_HW_CONFIGURATION_FPM_HIGH_THRESHOLD_READ(r, p)                 MREAD_16((uint8_t *)p + 10, r)
#define RDD_DHD_HW_CONFIGURATION_FPM_HIGH_THRESHOLD_WRITE(v, p)                MWRITE_16((uint8_t *)p + 10, v)
typedef struct
{
...
#define RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_RESERVED1_NUMBER	6
#define RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_SCRATCHPAD_NUMBER	2
...
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DHD_FPM_LOW_THRESHOLD_DTS;

extern uint32_t RDD_DHD_FPM_LOW_THRESHOLD_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DHD_FPM_LOW_THRESHOLD_PTR(core_id)	( RDD_DHD_FPM_LOW_THRESHOLD_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DHD_FPM_LOW_THRESHOLD_ADDRESS_ARR[core_id] ))

typedef struct
{
	RDD_BYTES_2_DTS	entry;
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_DHD_FPM_HIGH_THRESHOLD_DTS;

extern uint32_t RDD_DHD_FPM_HIGH_THRESHOLD_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_DHD_FPM_HIGH_THRESHOLD_PTR(core_id)	( RDD_DHD_FPM_HIGH_THRESHOLD_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_DHD_FPM_HIGH_THRESHOLD_ADDRESS_ARR[core_id] ))
...
typedef enum
{
	...
	QM_QUEUE_DROP                     = 259,
	QM_QUEUE_DHD_CPU_TX_POST_0        = 260,
	QM_QUEUE_DHD_TX_POST_0            = 261,
	QM_QUEUE_DHD_CPU_TX_POST_1        = 262,
	QM_QUEUE_DHD_TX_POST_1            = 263,
	QM_QUEUE_DHD_CPU_TX_POST_2        = 264,
	QM_QUEUE_DHD_TX_POST_2            = 265,
	QM_QUEUE_DHD_MCAST                = 266,
...
typedef enum
{
	...
	DISP_REOR_VIQ_DHD_RX_COMPLETE_0    = 24,
	DISP_REOR_VIQ_G9991_REASS1         = 25,
	DISP_REOR_VIQ_DHD_RX_COMPLETE_1    = 25,
	DISP_REOR_VIQ_DHD_RX_COMPLETE_2    = 26,
	DISP_REOR_VIQ_DHD_MCAST            = 27,
...
typedef enum
{
	...
	IMAGE_1_CPU_IF_1_CPU_RX_THREAD_NUMBER                   = 1,
	...
	IMAGE_1_CPU_IF_1_DHD_TX_POST_0_THREAD_NUMBER            = 5,
	IMAGE_1_CPU_IF_1_DHD_TX_POST_1_THREAD_NUMBER            = 6,
	IMAGE_1_CPU_IF_1_DHD_TX_POST_2_THREAD_NUMBER            = 7,
	IMAGE_1_CPU_IF_1_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER  = 8,
	IMAGE_1_CPU_IF_1_DHD_TIMER_THREAD_NUMBER                = 9,
	IMAGE_1_CPU_IF_1_DHD_MCAST_THREAD_NUMBER                = 10,
	IMAGE_1_CPU_IF_1_DHD_MCAST_UPDATE_FIFO_THREAD_NUMBER    = 11,
	IMAGE_1_CPU_IF_1_CPU_RECYCLE_THREAD_NUMBER              = 12,
	IMAGE_1_CPU_IF_1_CPU_RX_COPY_THREAD_NUMBER              = 13,
	IMAGE_1_CPU_IF_1_CPU_RX_COPY_UPDATE_FIFO_THREAD_NUMBER  = 14,
	IMAGE_1_CPU_IF_1_LAST                                   = 14
} rdd_cpu_if_1;
typedef enum
{
	...
	IMAGE_2_CPU_IF_2_DHD_TX_COMPLETE_0_THREAD_NUMBER     = 7,
	IMAGE_2_CPU_IF_2_DHD_TX_COMPLETE_1_THREAD_NUMBER     = 8,
	IMAGE_2_CPU_IF_2_DHD_TX_COMPLETE_2_THREAD_NUMBER     = 9,
	IMAGE_2_CPU_IF_2_DHD_RX_COMPLETE_0_THREAD_NUMBER     = 10,
	IMAGE_2_CPU_IF_2_DHD_RX_COMPLETE_1_THREAD_NUMBER     = 11,
	IMAGE_2_CPU_IF_2_DHD_RX_COMPLETE_2_THREAD_NUMBER     = 12,
	IMAGE_2_CPU_IF_2_LAST                                = 12
} rdd_cpu_if_2;
typedef enum
{
	CPU_IF_RDD_FIRST      = 0,
...
typedef enum
{
	...
	IMAGE_1_CPU_IF_1_TIMER_INDEX_DHD_AGGR                 = 2,
...
typedef enum
{
	...
	GENERAL_COUNTER_DHD_TX_POST_PKTS_0        = 1,
	GENERAL_COUNTER_DHD_TX_POST_PKTS_1        = 2,
	GENERAL_COUNTER_DHD_TX_POST_PKTS_2        = 3,
	GENERAL_COUNTER_DHD_TX_COMPLETE_PKTS_0    = 4,
	GENERAL_COUNTER_DHD_TX_COMPLETE_PKTS_1    = 5,
	GENERAL_COUNTER_DHD_TX_COMPLETE_PKTS_2    = 6,
	GENERAL_COUNTER_DHD_RX_COMPLETE_PKTS_0    = 7,
	GENERAL_COUNTER_DHD_RX_COMPLETE_PKTS_1    = 8,
	GENERAL_COUNTER_DHD_RX_COMPLETE_PKTS_2    = 9,
	GENERAL_COUNTER_LAST                      = 9
} rdd_general_counter;
typedef enum
{
	FLOW_DEST_FIRST      = 0,
...
#define DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_LOW_OFFSET                         24
...
#define DHD_POST_COMMON_RADIO_ENTRY_DHD_DOORBELL_HIGH_OFFSET                        28
...
#define DHD_POST_COMMON_RADIO_ENTRY_ADD_LLCSNAP_HEADER_OFFSET                       40
...
#define DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_CPU_TX_OFFSET                40
...
#define DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_NON_UDP_TCP_OFFSET           40
...
#define DHD_POST_COMMON_RADIO_ENTRY_AGGREGATION_BYPASS_TCP_PKTLEN_OFFSET            41
...
#define DHD_POST_COMMON_RADIO_ENTRY_CACHE_CTX_NEXT_WRITE_IDX_OFFSET                 42
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_OFFSET            44
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_THRESHOLDS_F_OFFSET_MOD16    8
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_OFFSET              48
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUTS_F_OFFSET_MOD16      8
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_OFFSET         52
#define DHD_POST_COMMON_RADIO_ENTRY_PER_AC_AGGREGATION_TIMEOUT_CNTRS_F_OFFSET_MOD16 0
#define DHD_POST_COMMON_RADIO_ENTRY_SCRATCHPAD_OFFSET                               56
...
/* fields union = ring_value, size = 32 bits
	uint32_t	request_id   	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	req_reserved0	:6	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	buffer_type  	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	req_reserved1	:24	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
	uint32_t	status       	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	fr_id_drop_value	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = fr_id_drop_value, size = 16 bits
	uint32_t	flow_ring_id 	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	fr_reserved0 	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	drop         	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	fr_reserved1 	:7	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
 end fields union*/
#else
	uint32_t	ring_value   	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
/* fields union = ring_value, size = 32 bits
...
#define DHD_CPU_QM_DESCRIPTOR_PKT_ID_F_OFFSET                                 18
#define DHD_CPU_QM_DESCRIPTOR_PKT_ID_F_WIDTH                                  14
#define DHD_CPU_QM_DESCRIPTOR_PKT_ID_OFFSET                                   4
#define DHD_CPU_QM_DESCRIPTOR_PKT_ID_F_OFFSET_MOD16                           2
...
typedef struct
{
	...
	uint32_t	pkt_id       	:14	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
