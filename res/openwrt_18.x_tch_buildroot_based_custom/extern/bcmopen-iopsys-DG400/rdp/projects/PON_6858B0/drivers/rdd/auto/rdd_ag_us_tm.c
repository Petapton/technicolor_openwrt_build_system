...
int rdd_ag_us_tm_complex_scheduler_rl_cfg_get(uint32_t _entry, rdd_complex_scheduler_rl_cfg_t *complex_scheduler_rl_cfg)
{
    ...
    {
        if(rdp_core_to_image_map[i] == image_3_runner_image)
        {
...
int rdd_ag_us_tm_bbh_queue_descriptor_get(uint32_t _entry, rdd_bbh_queue_descriptor_t *bbh_queue_descriptor)
{
    int i;
...
int rdd_ag_us_tm_bbh_queue_descriptor_set(uint32_t _entry, rdd_bbh_queue_descriptor_t *bbh_queue_descriptor)
{
    int i;
...
int rdd_ag_us_tm_basic_scheduler_table_quantum_number_set(uint32_t _entry, uint8_t quantum_number)
{
    int i;
...
int rdd_ag_us_tm_basic_scheduler_table_quantum_number_get(uint32_t _entry, uint8_t *quantum_number)
{
    int i;
