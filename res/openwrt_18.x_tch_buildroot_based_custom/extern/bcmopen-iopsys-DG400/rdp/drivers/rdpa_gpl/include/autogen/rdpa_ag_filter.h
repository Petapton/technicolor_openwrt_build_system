...
typedef enum {
    ...
    rdpa_filter_attr_entry = 4, /* entry : RWF : aggregate[(filter_key)] filter_ctrl(rdpa_filter_ctrl_t) : Entry - Filter on a Port */
    rdpa_filter_attr_stats = 5, /* stats : RF : number[(filter_stats_key)] : Drop statistics */
