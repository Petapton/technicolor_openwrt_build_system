...
typedef enum {
    ...
    rdpa_ucast_attr_ipv4_host_address_table = 5, /* ipv4_host_address_table : RWADF : aggregate[] ipv4_host_address_table_entry(rdpa_ipv4_host_address_table_t) : IPv4 Host Addres */
    rdpa_ucast_attr_ipv6_host_address_table = 6, /* ipv6_host_address_table : RWADF : aggregate[] ipv6_host_address_table_entry(rdpa_ipv6_host_address_table_t) : IPv6 Host Addres */
    rdpa_ucast_attr_host_mac_address_table = 7, /* host_mac_address_table : RWADF : aggregate[] host_mac_address_table_entry(rdpa_host_mac_address_table_t) : Host MAC Address Ta */
    rdpa_ucast_attr_fc_accel_mode_table = 8, /* fc_accel_mode_table : RW : aggregate fc_accel_mode_entry(rdpa_fc_accel_mode_t) : Flow Cache Acceleration Mode (Layer3, Layer2  */
