...
typedef enum {
    ...
    rdpa_port_attr_cfg = 2, /* cfg : RW : aggregate port_dp(rdpa_port_dp_cfg_t) : Logical port configuration */
    rdpa_port_attr_tm_cfg = 3, /* tm_cfg : RW : aggregate port_tm(rdpa_port_tm_cfg_t) : TM configuration */
    rdpa_port_attr_sa_limit = 4, /* sa_limit : RW : aggregate port_sa_limit(rdpa_port_sa_limit_t) : SA limit configuration */
    rdpa_port_attr_def_flow = 5, /* def_flow : RW : aggregate classification_result(rdpa_ic_result_t ) : DS default flow classification. Wifi: last default flow w */
    rdpa_port_attr_stat = 6, /* stat : RW : aggregate stat(rdpa_port_stat_t) : Port statistics */
    rdpa_port_attr_flow_control = 7, /* flow_control : RW : aggregate port_flow_control(rdpa_port_flow_ctrl_t) : The port flow control */
    rdpa_port_attr_mirror_cfg = 8, /* mirror_cfg : RW : aggregate port_mirror_cfg(rdpa_port_mirror_cfg_t) : Port mirroring configuration */
    rdpa_port_attr_vlan_isolation = 9, /* vlan_isolation : RW : aggregate vlan_isolation(rdpa_port_vlan_isolation_t) : LAN port VLAN isolation control */
    rdpa_port_attr_transparent = 10, /* transparent : RW : bool : LAN port transparent control */
    rdpa_port_attr_loopback = 11, /* loopback : RW : aggregate port_loopback_conf(rdpa_port_loopback_t) : Port loopbacks */
    rdpa_port_attr_mtu_size = 12, /* mtu_size : RW : number : Port MTU */
    rdpa_port_attr_cpu_obj = 13, /* cpu_obj : RW : object : CPU object for exception/forwarding-through-cpu packets */
