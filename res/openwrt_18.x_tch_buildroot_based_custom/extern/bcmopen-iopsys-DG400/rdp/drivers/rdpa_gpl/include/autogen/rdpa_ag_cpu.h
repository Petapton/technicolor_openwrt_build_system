...
typedef enum {
    ...
    rdpa_cpu_attr_rxq_stat = 4, /* rxq_stat : RF : aggregate[] cpu_rx_stat(rdpa_cpu_rx_stat_t) : Rx statistics */
    ...
    rdpa_cpu_attr_meter_stat = 6, /* meter_stat : RF : number[(rdpa_dir_index)] : CPU meter drop counter */
    ...
    rdpa_cpu_attr_reason_stat = 8, /* reason_stat : RF : number[(cpu_reason_index)] : Per trap reason statistics */
    ...
    rdpa_cpu_attr_l4_dst_port_to_reason = 16, /* l4_dst_port_to_reason : RWADF : aggregate[] l4_dst_port_to_reason_cfg(rdpa_l4_dst_port_to_reason_cfg_t) : TCP/UDP dst port to  */
    rdpa_cpu_attr_tc_to_rxq = 17, /* tc_to_rxq : RWF : number[] : TC to CPU RX queue mapping */
} rdpa_cpu_attr_types;
