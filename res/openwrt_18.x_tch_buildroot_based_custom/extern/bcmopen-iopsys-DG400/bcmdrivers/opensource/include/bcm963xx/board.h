...
extern unsigned long board_get_dsl_base(void);
...
#define TCH_RESERVE_MEM_NUM             1

#define TOTAL_RESERVE_MEM_NUM          (ADSL_RESERVE_MEM_NUM+RDPA_RESERVE_MEM_NUM+DHD_RESERVE_MEM_NUM+TCH_RESERVE_MEM_NUM)
