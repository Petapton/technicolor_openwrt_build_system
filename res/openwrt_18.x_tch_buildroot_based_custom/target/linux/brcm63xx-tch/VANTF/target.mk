...
INC_SPUDRV_PATH:=$(BRCMDRIVERS_DIR)/opensource/char/spudd/impl2
...
export BRCMDRIVERS_DIR BCM_USERSPACE_DIR SHARED_DIR \
       ...
       INC_RDPA_PATH INC_RDPA_MW_PATH INC_RDPA_DRV_PATH INC_RDPA_PATH_PLATFORM \
       INC_BDMF_PATH INC_RDPA_EXT_PATH_PLATFORM RDP_PATH INC_ENET_DMA_FLAGS \
       EXTRA_CFLAGS_RDPA EXTRA_CFLAGS_BDMF
